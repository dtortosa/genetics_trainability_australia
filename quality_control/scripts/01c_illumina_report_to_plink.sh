...
./scripts/01b_illumina_report_to_plink.py --batch_name="ILGSA24-17303" --n_cores="all" --n_samples=4 > ./scripts/01b_illumina_report_to_plink_ILGSA24_17303.out 2>&1 &
	#--n_samples=216 is the max, defult is 2
sleep 1s
...
./scripts/01b_illumina_report_to_plink.py --batch_name="ILGSA24-17873" --n_cores="all" --n_samples=4 > ./scripts/01b_illumina_report_to_plink_ILGSA24_17873.out 2>&1 &
	#--n_samples=1248 is the max, defult is 2
