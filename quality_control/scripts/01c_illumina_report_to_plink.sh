...
./scripts/01b_illumina_report_to_plink.py --batch_name="ILGSA24-17303" --n_cores=2 --n_samples=4 > ./scripts/01b_illumina_report_to_plink_ILGSA24_17303.out 2>&1 &
...
./scripts/01b_illumina_report_to_plink.py --batch_name="ILGSA24-17873" --n_cores=2 --n_samples=4 > ./scripts/01b_illumina_report_to_plink_ILGSA24_17873.out 2>&1 &
